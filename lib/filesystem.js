 ...
 * @param {boolean} hierarchical    Whether to include reading the sub-directories.
        ...
        fs.readdir( dir, async (err, files) => {
            ...
            for ( let i = 0; i < files.length; i++ ) {
                ...
                if ( isObject ) {
                    ...
                    if ( isDir ) {
                        let child = await readDir( filePath, hierarchical, isObject, types );
...
setGlobalVar( 'deleteFile', deleteFile );